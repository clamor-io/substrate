...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	pub fn do_touch(id: T::AssetId, who: T::AccountId) -> DispatchResult {
	...
	pub fn do_refund(id: T::AssetId, who: T::AccountId, allow_burn: bool) -> DispatchResult {
